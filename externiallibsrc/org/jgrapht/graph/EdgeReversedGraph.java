 ...
 * Contributor(s):   -
 *
 * $Id: EdgeReversedGraph.java,v 1.2 2007/05/22 15:52:54 kjellw Exp $
 *
 * Changes
 * -------
 ...
 */
public class EdgeReversedGraph<V, E> extends GraphDelegator<V, E> implements
		DirectedGraph<V, E> {
	 ...
	 * 
	 * @param g
	 *            the base (backing) graph on which the edge-reversed view will
	 *            be based.
	 */
