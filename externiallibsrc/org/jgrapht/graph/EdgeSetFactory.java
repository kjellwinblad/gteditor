 ...
 *
 * $Id: EdgeSetFactory.java,v 1.2 2007/05/22 15:52:54 kjellw Exp $
 *
 * Changes
 * -------
...
public interface EdgeSetFactory<V, E> {
	 ...
	 * 
	 * @param vertex
	 *            the vertex for which the edge set is being created;
	 *            sophisticated factories may be able to use this information to
	 *            choose an optimal set representation (e.g. ArrayUnenforcedSet
	 *            for a vertex expected to have low degree, and LinkedHashSet
	 *            for a vertex expected to have high degree)
	 * 
	 * @return new set
	 */
