 ...
 * Contributor(s):   -
 *
 * $Id: GraphGenerator.java,v 1.2 2007/05/22 15:52:53 kjellw Exp $
 *
 * Changes
 * -------
...
public interface GraphGenerator<V, E, T> {
	 ...
	 *            elements
	 * @param vertexFactory
	 *            called to produce new vertices
	 * @param resultMap
	 *            if non-null, receives implementation-specific mappings from
	 *            String roles to graph elements (or collections of graph
	 *            elements)
	 */
	public void generateGraph(Graph<V, E> target,
			VertexFactory<V> vertexFactory, Map<String, T> resultMap);
}
