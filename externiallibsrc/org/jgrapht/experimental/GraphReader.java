 ...
 * Contributor(s):   -
 *
 * $Id: GraphReader.java,v 1.2 2007/05/22 15:52:59 kjellw Exp $
 *
 * Changes
 * -------
...
public class GraphReader<V, E> implements GraphGenerator<V, E, V> {
	...
	public void generateGraph(Graph<V, E> target,
		...
		while (cols != null) {
			if (cols.get(0).equals("e")) {
				target.addEdge(resultMap.get(cols.get(1)), resultMap.get(cols
						.get(2)));
			}
			cols = skipComments();
		}
	...
	private static final class IntVertexFactory implements
