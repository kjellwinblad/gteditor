 ...
 * Contributor(s):   -
 *
 * $Id: UniformRandomGraphGenerator.java,v 1.2 2007/05/22 15:52:59 kjellw Exp $
 *
 * Changes
 * -------
...
public class UniformRandomGraphGenerator implements GraphGenerator {
	...
	public void generateGraph(Graph target, VertexFactory vertexFactory,
			Map resultMap) {
		Object[] vertices = RandomGraphHelper.addVertices(target,
				vertexFactory, numVertices);
		RandomGraphHelper.addEdges(target, Arrays.asList(vertices), Arrays
				.asList(vertices), numEdges);
	}
}
