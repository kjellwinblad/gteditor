 ...
 *
 * $Id: VertexSetListener.java,v 1.2 2007/05/22 15:52:58 kjellw Exp $
 *
 * Changes
 * -------
 ...
 * used when <i>only</i> notifications on vertex-set changes are of interest.
 * If all graph notifications are of interest better use <code>
 * GraphListener</code>.
 * 
 * @author Barak Naveh
 * @see GraphListener
