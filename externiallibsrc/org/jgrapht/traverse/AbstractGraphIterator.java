 ...
 *
 * $Id: AbstractGraphIterator.java,v 1.2 2007/05/22 15:52:50 kjellw Exp $
 *
 * Changes
 * -------
 ...
 * @since Jul 19, 2003
 */
public abstract class AbstractGraphIterator<V, E> implements
		GraphIterator<V, E> {
	// ~ Instance fields
	// --------------------------------------------------------
	 ...
	 * 
	 * @param crossComponentTraversal
	 *            if <code>true</code> traverses across connected components.
	 */
