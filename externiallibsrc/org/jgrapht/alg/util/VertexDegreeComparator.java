 ...
 * ---------------------------
 * (C) Copyright 2003-2006, by Linda Buisman and Contributors.
 *
 * Original Author:  Linda Buisman
 * Contributor(s):   Christian Hammer
 *
 * $Id: VertexDegreeComparator.java,v 1.2 2007/05/22 15:52:58 kjellw Exp $
 *
 * Changes
 * -------
...
public class VertexDegreeComparator<V, E> implements java.util.Comparator<V> {
	 ...
	 *            true - compares in ascending order of degrees (lowest first),
	 *            false - compares in descending order of degrees (highest
	 *            first).
	 */
	public VertexDegreeComparator(UndirectedGraph<V, E> g,
	 ...
	 * into account whether ascending or descending order is used.
	 * 
	 * @param v1
