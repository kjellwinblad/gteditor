 ...
 *                   Christian Hammer
 *
 * $Id: Graph.java,v 1.2 2007/05/22 15:52:55 kjellw Exp $
 *
 * Changes
 * -------
 ...
 * object <tt>G(V,E)</tt> contains a set <tt>V</tt> of vertices and a set
 * <tt>
 * E</tt> of edges. Each edge e=(v1,v2) in E connects vertex v1 to vertex
 ...
 * <code>V</code> and edges <code>E&lt;T&gt;</code>. Such a graph can
 * contain vertices of type <code>V</code> and all sub-types and Edges of type
 * <code>
...
public interface Graph<V, E> {
	 ...
	 * or is <code>null</code>, returns <code>null</code>. If both
	 * vertices exist but no edges found, returns an empty set.
	 * 
	 * <p>
	 ...
	 * null</code>.
	 * If any of the specified vertices is <code>null</code> returns
	 * <code>null</code>
	 * 
	 * <p>
	 ...
	 * edge <code>e2</code> such that <code>e2.equals(e)</code>. If such
	 * <code>
	 * e2</code> is found then the newly created edge <code>e</code>
	 * is abandoned, the method leaves this graph unchanged returns <code>
	 * null</code>.
	 * </p>
	 * 
	 * @param sourceVertex
	 ...
	 * e</code>,
	 * to this graph if this graph contains no edge <code>e2</code> such that
	 * <code>e2.equals(e)</code>. If this graph already contains such an
	 * edge, the call leaves this graph unchanged and returns <tt>false</tt>.
	 ...
	 *             if the specified edge is not assignment compatible with the
	 *             class of edges produced by the edge factory of this graph.
	 * @throws NullPointerException
	 *             if any of the specified vertices is <code>
	 * null</code>.
	 * 
	 ...
	 * {@link java.util.LinkedHashSet}) for deterministic iteration, but this
	 * is not required. It is the responsibility of callers who rely on this
	 ...
	 * <code>null</code> if any of the specified vertices does not exist in
	 * the graph. If both vertices exist but no edge is found, returns an empty
	 * set. This method will either invoke the {@link #removeEdge(Object)}
	 ...
	 * e2</code>
	 * such that <code>e2.equals(e)</code>, if the graph contains such edge.
	 * Returns <tt>true</tt> if the graph contained the specified edge. (The
	 ...
	 * u</code>
	 * such that <code>u.equals(v)</code>, the call removes all edges that
	 * touch <code>u</code> and then removes <code>u</code> itself. If no
