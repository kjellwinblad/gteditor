...
/**
 * Defines the requirements for an object that represents a view for a model
 * cell.
 * 
 * @version 1.0 1/1/02
...
public interface CellView {
	...
	/**
	 * Refresh this view based on the model cell. This is messaged when the
	 * model cell has changed.
	 */
	void refresh(GraphModel model, CellMapper mapper,
			boolean createDependentViews);

	/**
	 * Update this view's attributes. This is messaged whenever refresh is
	 * messaged, and additionally when the context of the cell has changed, and
	 * during live-preview changes to the view.
	 */
	void update();
	 ...
	 */
	Component getRendererComponent(JGraph graph, boolean selected,
