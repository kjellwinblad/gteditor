...
/**
 * An object that represents the clipboard contents for a graph selection. The
 * object has three representations:
 * <p>
 * 1. Richer: The cells, view attributes and connections for this selection are
 * stored as separate datastructures, which can be inserted using the
 * GraphModel.insert() method. 2. HTML: If one cell is selected, the userObject
 * is returned as HTML. 3. Plain: The userObject of the selected cell is
...
public class GraphTransferable extends BasicGraphTransferable implements
		Serializable, ClipboardOwner {
	 ...
	 */
	public GraphTransferable(Object[] cells, Map attrMap, Rectangle2D bounds,
	...
	/**
	 * Returns the connections between <code>cells</code> (and possibly other,
	 * unselected cells).
	 */
	...
	/**
	 * Returns a map of (GraphCell, Map)-pairs that represent the view
	 * attributes for the respecive cells.
	 */
	...
	static {
		...
		try {
			localDataFlavor = new DataFlavor(
