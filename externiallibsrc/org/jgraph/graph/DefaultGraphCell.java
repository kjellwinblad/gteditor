...
public class DefaultGraphCell extends DefaultMutableTreeNode implements
	 ...
	 * 
	 * @param userObject
	 *            an Object provided by the user that constitutes the cell's
	 *            data
	 */
	...
	/**
	 * Constructs a cell that holds a reference to the specified user object and
	 * contains the specified array of children and sets default values for the
	 * bounds attribute.
	 * 
	 * @param userObject
	...
	/**
	 * Provides access to the children list to change ordering. This method
	 * returns a <code>Collections.EMPTY_LIST</code> if the list of
	 * childrenpoints to <code>null</code>.
	 */
	...
	/**
	 * Utility method to create a port for this cell. This method adds a
	 * floating port.
	 */
	public void addPort() {
		addPort(null);
	...
	/**
	 * Utility method to create a port for this cell. The method adds a port at
	 * a fixed relative offset within the cell. If the offset is null then a
	 * floating port is added.
	 * 
	 * @param offset
	 ...
	 * implementation (which does not clone the children), then uses clone on
	 * the attribute map. This method does not clone the user object. You should
	 * override the cloneUserObject in the graph model to implement cloning of
	 * custom user objects.
	 * 
