...
public class DefaultCellViewFactory implements CellViewFactory, Serializable {
	 ...
	 * and ports are created. <b>Note: This method must return new instances!</b>
	 * 
	 * @param cell
	 ...
	 *             longer exposes dependecies on GraphCell subclasses (Port,
	 *             Edge)
	 */
	 ...
	 * Constructs a PortView view for the specified object.
	 * 
	 * @deprecated replaced by {@link #createPortView(Object)}since JGraph no
	 *             longer exposes dependecies on GraphCell subclasses (Port,
	 *             Edge)
	 */
