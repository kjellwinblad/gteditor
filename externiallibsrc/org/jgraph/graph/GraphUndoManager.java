...
public class GraphUndoManager extends UndoManager {
	 ...
	 * would be successful now for the given view, false otherwise
	 */
	...
	/**
	 * Overridden to preserve usual semantics: returns true if a redo operation
	 * would be successful now for the given view, false otherwise
	 */
	 ...
	 * wrt to source, and all insignificant edits back to it. Updates
	...
	protected UndoableEdit editToBeUndone(Object source) {
		...
		do {
			...
			if (edit instanceof GraphLayoutCacheEvent.GraphLayoutCacheChange)
				src = ((GraphLayoutCacheEvent.GraphLayoutCacheChange) edit)
						.getSource();
	...
	/**
	 * Returns the the next significant edit wrt to current to be undone if undo
	 * is called. May return null.
	 */
	...
	/**
	 * If this <code>UndoManager</code> is <code>inProgress</code>, redoes
	 * the last significant <code>UndoableEdit</code> with respect to source
	 * or after, and all insignificant edits up to it. Updates
	 * <code>indexOfNextAdd</code> accordingly.
	 * 
	 * <p>
	 * If not <code>inProgress</code>, <code>indexOfNextAdd</code> is
	 * ignored and super's routine is called.
	 * </p>
	 */
	...
	/**
	 * Returns the the next significant edit wrt to current to be redone if redo
	 * is called. May return null.
	 */
