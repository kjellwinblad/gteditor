...
public class DefaultGraphCellEditor implements ActionListener, GraphCellEditor,
	...
	/**
	 * Internal Note, maybe isCellEditable return true. This is set in configure
	...
	public DefaultGraphCellEditor(GraphCellEditor editor) {
		...
		setBorderSelectionColor(UIManager
				.getColor("Tree.editorBorderSelectionColor"));
	}
	 ...
	 * font should be used. This will NOT override any font you have set in the
	 * editor the receiver was instantied with. If null for an editor was passed
	 * in a default editor will be created that will pick up this font.
	 * 
	 * @param font
	 *            the editing Font
	 * @see #getFont
	...
	public Component getGraphCellEditorComponent(JGraph graph, Object cell,
		...
		editingComponent = realEditor.getGraphCellEditorComponent(graph, cell,
				isSelected);
	...
	/**
	 * Returns true if <code>event</code> is a MouseEvent and the click count
	 * is 1.
	 */
	...
	/**
	 * Returns true if <code>event</code> is null, or it is a MouseEvent with
	...
	protected void determineOffset(JGraph graph, Object value,
			boolean isSelected) {
		editingIcon = null;
	...
	protected GraphCellEditor createGraphCellEditor() {
		...
		DefaultRealEditor editor = new DefaultRealEditor(new DefaultTextField(
				aBorder)) {
			public boolean shouldSelectCell(EventObject event) {
