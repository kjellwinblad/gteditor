...
public abstract class GraphUI extends ComponentUI {
	 ...
	 * <code>bounds</code>.
	 */
	public abstract void paintCell(Graphics g, CellView view,
			Rectangle2D bounds, boolean preview);
	 ...
	 */
	public abstract void selectCellsForEvent(JGraph graph, Object[] cells,
			MouseEvent event);
	...
	/**
	 * Returns the <code>CellHandle</code> that is currently active, or
	 * <code>null</code> if no handle is active.
	 */
	public abstract CellHandle getHandle();

	/**
	 * Returns true if the graph is being edited. The item that is being edited
	 * can be returned by getEditingCell().
	 */
	...
	/**
	 * Cancels the current editing session. This has no effect if the graph
	 * isn't being edited. Returns true if the editor allows the editing session
	 * to stop.
	 */
