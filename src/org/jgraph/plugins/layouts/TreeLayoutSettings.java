...
public class TreeLayoutSettings extends JPanel implements JGraphLayoutSettings {
	...
	private JComboBox alignmentCombo = new JComboBox(new Object[] { "Top",
			"Center", "Bottom" });

	private JComboBox orientationCombo = new JComboBox(new Object[] { "North",
			"East", "South", "West" });
	...
	public void revert() {
		...
		levelDistanceTextField.setText(String
				.valueOf(layout.getLevelDistance()));
	}
	...
	public void apply() {
		...
		layout.setNodeDistance(Integer
				.parseInt(nodeDistanceTextField.getText()));
		layout.setLevelDistance(Integer.parseInt(levelDistanceTextField
				.getText()));
	}
